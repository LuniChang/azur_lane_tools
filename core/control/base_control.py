...
class BaseControl:
    ...
    def isNewMission(self):  # TODO 待优化
        ...
        return screen.autoCompareResImgHashValue(self.handle, "new_mission_28_26_70_76.png") > 0.1 \
            or screen.autoCompareResImgHashValue(self.handle, "newtask_28_26_70_30.png") > 0.15  \
            or screen.autoCompareResImgHashValue(self.handle, "newtask_30_68_66_76.png") > 0.15
